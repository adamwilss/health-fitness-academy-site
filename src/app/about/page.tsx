...
export default function AboutPage() {
  return (
    <main className="relative">
      ...
      {/* Feature image — practical training environment */}
      <Reveal>
        <section className="relative overflow-hidden bg-bg-secondary">
          <div className="mx-auto max-w-6xl px-5 sm:px-8">
            <div className="relative -mx-5 overflow-hidden sm:-mx-8" style={{ height: 'clamp(260px, 32vw, 400px)' }}>
              <Image
                src="/images/hfa-01-stretch.jpg"
                alt="Student performing a pigeon stretch on a mat in the Health Fitness Academy training studio"
                fill
